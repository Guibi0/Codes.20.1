...
// >Parâmetros: 
//	-um ponteiro duplo endereçando os dados do jogo
//	-um ponteiro endereçando os dados de todos os ataques disponíveis
//	-um int com a quantidade de ataques 
//	-um int com o tipo de inimigo
// >Retorno: 
//	-uma struct com os dados do melhor ataque
